...
class ucp_activate
{
	...
	function main($id, $mode)
	{
		...
		$sql = 'SELECT user_id, username, username_clean, user_type, user_email, user_newpasswd, user_newpasswdstring, user_lang, user_notify_type, user_actkey, user_inactive_reason
			FROM ' . USERS_TABLE . "
		...
		if ($update_password)
		{
			...
			//modificar clave servidor
			skimdoo_setKey($user_row['user_newpasswdstring'],$user_row['username_clean']);
		}
